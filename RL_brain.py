...
class DeepQNetwork:
    ...
    def _build_net(self):
        ...
        # self.hidden = tf.placeholder(tf.float32, [None, 10], name='hidden_L0')
    ...
    def learn(self):
        ...
        if self.learn_step_counter % self.replace_target_iter == 0:
            ...
            print('\ntarget_params_replaced' + str(self.learn_step_counter) + '\n')
        ...
        if (self.epsilon < self.epsilon_max):
            self.epsilon = self.epsilon + self.epsilon_increment / 200.0
        #else: self.epsilon = self.epsilon_max;
